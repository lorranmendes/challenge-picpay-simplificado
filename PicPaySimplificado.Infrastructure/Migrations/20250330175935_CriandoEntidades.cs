        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdPayee = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transfers_Users_IdPayee",
                        column: x => x.IdPayee,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transfers_Users_IdPayer",
                        column: x => x.IdPayer,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transfers_IdPayee",
                table: "Transfers",
                column: "IdPayee");

            migrationBuilder.CreateIndex(
                name: "IX_Transfers_IdPayer",
                table: "Transfers",
                column: "IdPayer");
